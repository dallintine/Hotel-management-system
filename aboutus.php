...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="200">
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="row">
					<div class="col-xs-12 col-sm-4">
					   <nav class="hidden-xs col-sm-5" id="myScrollspy">
        ...
        <div id="history" class="row row-about">
            <div class="col-xs-12 col-sm-6 col-lg-8">
                <h2>Our History<small>Our History</small></h2>
        ...
        <div id="corporate" class="row row-about">
